...
if [[ "$istermux" == false ]]; then
  ...
  export PATH="${HOME}/userpythonenv/bin:${JAVA_HOME}/bin:${PATH}:${HOME}/binaries:/usr/sbin:/sbin:/bin:${PREFIX}/bin:${PREFIX}/local/bin:/system/bin:/system/xbin:${HOME}/PMD/bin:${HOME}/wabt/bin:${HOME}/LearnJava:${HOME}/LearnBnd:/usr/local/go/bin:${HOME}/.local/share/gem/ruby/3.3.0/bin:${HOME}/Duckdb"
